<!-- cycle section start -->
<div id="cycle" class="cycle_section layout_padding">
	<div class="container">
		...
		foreach ($data as $produk) {
			echo "<div class='cycle_section_2 layout_padding'>";
			echo "<div class='row'>";
			echo "<div class='col-md-6'>";
			echo "<div class='box_main'>";
			echo "<h6 class='number_text'>$produk[id]</h6>";
			echo "<div class='image_2'><img src='images/$produk[img]'></div>";
			echo "</div>";
			echo "</div>";
			echo "<div class='col-md-6'>";
			echo "<h1 class='cycles_text'>$produk[nama]</h1>";
			echo "<p class='lorem_text'>$produk[deskripsi]</p>";
			echo "<div class='btn_main'>";
			echo "<div class='buy_bt'><a href='checkout.php'>Buy Now</a></div>";
			echo "<h4 class='price_text'>Price <span style=' color: #f7c17b'>$</span> <span
			style='color: #325662'>$produk[harga_jual]</span></h4>";
			echo "</div>";
			echo "</div>";
			echo "</div>";
			echo "</div>";
...
<div id="news" class="news_section layout_padding">
	<div class="container">
		...
		<p class="news_text">It is a long established fact that a reader will be distracted by the readable content of a
