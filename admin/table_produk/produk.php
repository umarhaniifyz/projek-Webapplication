                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary"
                                href="index.php?key=table_produk/view_produk&id=<?= $row['id'] ?>">View</a>
                            <a class="btn btn-secondary"
                                href="index.php?key=table_produk/form_produk&idedit=<?= $row['id'] ?>">Edit</a>
                            <a class="btn btn-danger" href="table_produk/delete_produk.php?iddel=<?= $row['id'] ?>"
